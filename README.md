# Bicycle Rental Website (VelOrda)

The task is to build a static website using only HTML and CSS for a bicycle rental company called VelOrda. The website promotes cycling in the city and provides information about available bicycles, pricing plans, and frequently asked questions.
